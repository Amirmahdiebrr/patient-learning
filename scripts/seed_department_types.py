...
taxonomy (StandardDepartmentType): 6 macro categories, ~29 specific
department types. Run once (or re-run safely anytime - it upserts).
...
# (macro_category, code, name, display_order)
DEPARTMENT_TYPES = [
    # ---- Surgical ----
